...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'stock-analysis': { name: 'Stock Analysis', enabled: false, priority: 1, premium: 'locked' as const },
  'stock-backtest': { name: 'Backtesting', enabled: false, priority: 1, premium: 'locked' as const },
  'daily-market-brief': { name: 'Daily Market Brief', enabled: false, priority: 1, premium: 'locked' as const },
  ...
  'trade-policy': { name: 'Trade Policy', enabled: false, priority: 1, premium: 'locked' as const },
  ...
  'market-implications': { name: 'AI Market Implications', enabled: false, priority: 1, premium: 'locked' as const },
